...
// MS5803_07BA I2C address is 0x76(118)
#define Addr 0x76
...
void loop() 
{
  ...
  unsigned long long off = (unsigned long long)Coff[1] * (unsigned long long)262144 + (Coff[3] * dT) / 32;
  unsigned long long sens = (unsigned long long)Coff[0] * (unsigned long long)131072 + (Coff[2] * dT) / 64;
